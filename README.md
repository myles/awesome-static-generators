...
*   [Astro](https://docs.astro.build/) - `#JavaScript` `#Node.Js` `#React.js` `#Vue.js` `#Svelte.js` Framework agnostic static site generator with component-level support for partial hydration on page load, page idle, component visible or none.
