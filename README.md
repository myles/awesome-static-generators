...
- [indexgap](https://github.com/borisowlexa2010-star/IndexGap) - Audits generated pages before publishing: checks the numbers on a page against the data row it came from, collapses template-wide breakage into one fix, clusters near-duplicates and validates hreflang. - `#Python`
